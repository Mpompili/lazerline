...
class Lazerline {
    ...
    addPlayer(x, y, dx, dy, c, isComp, dir) {
        const player = new Player(x, y, dx, dy, c, isComp, dir, 'PLAYER');
        this.players.push(player); 
        return player; 
    }

    humanPlayer() {
        return this.addPlayer(500 / 2 / SCL, (500 - 50) / SCL, 0, -1, "#FFF", false, ["up", [0, -1]]);
    }

    computerPlayer() {
        switch(this.players.length){
            case 1:
                return this.addPlayer(500 / 2 / SCL, 50 / SCL, 0, 1, "#00FF7F", true, ["down", [0, 1]], "JESSICA");
            case 2: 
                 return this.addPlayer(50 / SCL - 5, 500 / 2 / SCL, 1, 0, "#F50", true, ["right", [1, 0]], "REBECCA"); 
            case 3:
                return this.addPlayer((500 - 50) / SCL + 5, 500 / 2 / SCL, -1, 0, "#00FFFF", true, ["left", [-1, 0]], "TAMMY");    
            default: 
                return; 
            }
    }
