...
class Lazerline {
    ...
    humanPlayer() {
        return this.addPlayer(500 / 2 / SCL, (500 - 50) / SCL, 0, -1, "#E7FFFF", false, ["up", [0, -1]]);
    }
    ...
    computerPlayer() {
        switch(this.players.length){
            ...
            case 2: 
                 return this.addPlayer(50 / SCL - 5, 500 / 2 / SCL, 1, 0, "#FF4500", true, ["right", [1, 0]]); 
            case 3:
                return this.addPlayer((500 - 50) / SCL + 5, 500 / 2 / SCL, -1, 0, "#FEE55B", true, ["left", [-1, 0]]);    
            default: 
                return; 
            }
